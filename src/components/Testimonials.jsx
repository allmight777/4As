...
const TESTIMONIALS = [
  {
    ...
    date: 'Mariage en septembre, Ouidah',
    quote:
  ...
  {
    names: 'Léa & Sophie',
    date: 'Mariage en juin, Grand-Popo',
    quote:
  ...
  {
    names: 'Inès & Karim',
    date: 'Mariage en octobre, Possotomè, lac Ahémé',
    quote:
    ...
    <section id="avis" className="section section--ivory testimonials">
      <div className="container testimonials__layout">
        <div className="testimonials__portrait reveal" ref={portraitRef}>
          <img src={TESTIMONIALS_IMAGE} alt="Illustration d'un couple de mariés" loading="lazy" decoding="async" />
        </div>
